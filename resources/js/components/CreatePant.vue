                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row mt-3">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label>Choose Pant Pleat</label>
                                    <select class="form-control"
                                    v-bind:class="{
                                            'border-danger': forrequire(
                                                this.requireerroryk.pant_pleat_id,
                                                this.pant.pant_pleat_id
                                            ),
                                        }"
                                    v-model="pant.pant_pleat_id" name="btn_text">
                                        <option selected hidden>Choose Pant Pleat</option>
                                        <option v-for="(pant_pleat,index) in pant_pleats" :key="index" :value="pant_pleat.name">{{pant_pleat.name}}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-6">
                    ...
                    <button type="submit"  @click="store_pant" class="btn btn-primary">Submit</button>
                    </div>
                </div>
            </div>
        </div>
     ...
     components: {
      ...
      methods: {
        ...
        store_pant(){
            ...
            if (this.pant.pant_pleat_id == "") {
                this.requireerroryk.pant_pleat_id = true;
                tmperrorcounts += 1;
            } else {this.requireerroryk.pant_pleat_id = false;}
            ...
            if (tmperrorcounts == 0) {
                ...
                if(this.requireerroryk.pant_pleat_id) {
                  alertText[i] = "need to select the pleat";
                  i++;
                }
            ...
            let formData = new FormData();
                ...
                formData.append('color', this.pant.pant_pleat_id);
            ...
            .then(function (response){
                swal({
                    ...
                    window.location = 'show_pant_list';
                });
        ...
        getPant_pleat(){
            axios.get('/get_pant_pleat_ajax')
            .then((response) => {
                console.log(response.data);
                this.pant_pleats = response.data.pant_pleats;
            })
            .catch(function (error){
                alert("wrong");
            })
