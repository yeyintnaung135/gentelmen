                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" v-model="size.name" class="form-control"
                            v-bind:class="{
                        ...
                        <div class="form-group">
                            <label>Price</label>
                            <input type="text" v-model="size.price" class="form-control"
                            v-bind:class="{
                                            'border-danger': forrequire(
     ...
     components: {
      ...
      methods: {
        ...
        submitform(){
            ...
            axios.post('create_size',formData,config)
