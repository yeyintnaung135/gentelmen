...
import 'vue2-dropzone/dist/vue2Dropzone.min.css'
      ...
      methods: {
        ...
        headers: { 'content-type': 'multipart/form-data' }
            ...
            let formData = new FormData();
                ...
                formData.append('price', this.size.name);
                formData.append('price', this.size.price);
            ...
            axios.post('/store_size',formData,config)
...

        {
            ...
            let formData = new FormData();
                ...
                formData.append('size_id', this.link);
            ...
            axios.post('/store_edit_size',formData,config)
    ...
    mounted() {
        ...
        axios.post('/get_edit_size',sizeID)
        .then( (response) => {
            // alert("access");

            this.size.name = response.data.sizes.name
            this.size.price = response.data.sizes.price
            // window.location.reload();
            if(response.data.sizes.photo_one != null)
                  {
                var file1 = { size: 123, name: "Photo One", type: "image/png" };
                this.url1 = "/assets/images/categories/size/"+response.data.sizes.photo_one;
                this.$refs.myVueDropzone.manuallyAddFile(file1, this.url1);
                  }
                if(response.data.sizes.photo_two != null)
              {
              var file2 = { size: 123, name: "Photo Two", type: "image/png" };
              this.url2 = "/assets/images/categories/size/"+response.data.sizes.photo_two;
              this.$refs.myVueDropzone.manuallyAddFile(file2, this.url2);
              }
              if(response.data.sizes.photo_three != null)
              {
              var file3 = { size: 123, name: "Photo Three", type: "image/png" };
              this.url3 = "/assets/images/categories/size/"+response.data.sizes.photo_three;
              this.$refs.myVueDropzone.manuallyAddFile(file3, this.url3);
              }
              if(response.data.sizes.photo_four != null)
              {
              var file4 = { size: 123, name: "Photo Four", type: "image/png" };
              this.url4 = "/assets/images/categories/size/"+response.data.sizes.photo_four;
              this.$refs.myVueDropzone.manuallyAddFile(file4, this.url4);
              }
              if(response.data.sizes.photo_five != null)
              {
                var file5 = { size: 123, name: "Photo Five", type: "image/png" };
                  this.url5 = "/assets/images/categories/size/"+response.data.sizes.photo_five;
                  this.$refs.myVueDropzone.manuallyAddFile(file5, this.url5);
              }

              if(response.data.sizes.photo_six != null)
              {
              var file6 = { size: 123, name: "Photo Six", type: "image/png" };
              this.url6 = "/assets/images/categories/size/"+response.data.sizes.photo_six;
              this.$refs.myVueDropzone.manuallyAddFile(file6, this.url6);
              }

              if(response.data.sizes.photo_seven != null)
              {
              var file7 = { size: 123, name: "Photo seven", type: "image/png" };
              this.url7 = "/assets/images/categories/size/"+response.data.sizes.photo_seven;
              this.$refs.myVueDropzone.manuallyAddFile(file7, this.url7);
              }
              if(response.data.sizes.photo_eight != null)
              {
              var file8 = { size: 123, name: "Photo eight", type: "image/png" };
              this.url8 = "/assets/images/categories/size/"+response.data.sizes.photo_eight;
              this.$refs.myVueDropzone.manuallyAddFile(file8, this.url8);
              }
              if(response.data.sizes.photo_nine != null)
              {
              var file9 = { size: 123, name: "Photo nine", type: "image/png" };
              this.url9 = "/assets/images/categories/size/"+response.data.sizes.photo_nine;
              this.$refs.myVueDropzone.manuallyAddFile(file9, this.url9);
              }
              if(response.data.sizes.photo_ten != null)
              {
              var file10 = { size: 123, name: "Photo ten", type: "image/png" };
              this.url10 = "/assets/images/categories/size/"+response.data.sizes.photo_ten;
