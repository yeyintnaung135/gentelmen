      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="padding-left: 33vw">
            <a  href="{{route('add_faq')}}" type="button" class="btn btn-primary">Create</a>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
                  ...
                  <tbody>
                    ...
                    <td>
                      <div style="
                          display: flex;
                      ">
                         <a type="button" class="btn btn-primary" href="{{route('edit_faq',$faq->id)}}" style="
                            width: 20%;
                        ">

                         <span class="fa fa-edit"></span>
                         </a>
                        <a type="button" onclick="delete_confirm('{{$faq->id}}')" class="btn btn-block btn-danger" style="
                            width: 20%;
                            margin-top: 0rem;
                            margin-left: 0.3rem;
