@extends('layouts.testerdashboard')
@section('content')
                                   ...
                                   <div class="row py-4">
                                       <div class="image_area col-lg-6 mx-auto">
                                           ...
                                           <div class="remove-img">
                                             ...
                                             <img id="imageResult" src="{{'/frontend/testimonial/'. $testimonial->photo}}" alt="" class="img-fluid rounded shadow-sm mx-auto d-block">
                                           </div>
                                           ...
                                           <div class="form-group" style="
                                             ...
                                             ">
                                             <label>Name</label>
                                             <input name="name" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Text" value="{{$testimonial->name}}">
                                           </div>
                                           
                                           <div class="form-group">
                                             <label>Description</label>
                                             <textarea name="description" type="textarea" class="form-control" id="exampleInputEmail1" placeholder="Enter Text" value="{{$testimonial->description}}">
                                 ...
                                 <div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
                                   <div class="modal-dialog modal-lg" role="document">
                                     <div class="modal-content">
                                           ...
                                           <div class="row">
                                             ...
                                             <div class="p-1">
                                                    ...
                                                    <span class="text-danger font-weight-bold m-1 text-center w-100">
                                                        ...
                                                        Photo size must be 400px x 300px 
                                                    </span>
                                                </div>
                                             </div>
                                           </div>
                                       ...
                                       <button type="button" class="btn btn-primary" id="testi-crop">Crop</button>
                                       </div>
                                     </div>
                                   </div>
                                 </div>
...
<script>
  ...
  testi_cropper = new Cropper(image, {
  aspectRatio: 1,
  viewMode: 3,
  preview: '.preview'
  });
  }).on('hidden.bs.modal', function () {
  testi_cropper.destroy();
  testi_cropper = null;
  });
  ...
  method: "POST",
  dataType: "json",
  url: "{{route('update_testimonial',$testimonial->id)}}",
  data: formData,
  error:function(err){
  ...
  success: function(response){
    if(response.success){
      swal({
          ...
          window.location.href = "{{ route('testimonial_list')}}";
        });
    }else{
        alert("Error");
    }
