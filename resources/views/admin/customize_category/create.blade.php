...
@section('content')
    ...
    <section class="content">
      <div class="container-fluid">
            <form action="{{route('store_customize_category')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                          ...
                          <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                  ...
                                  <input name="photo" type="file" class="form-control" id="exampleInputEmail1" placeholder="Enter Fabric & Texture Name">
                                  @error('photo')
                                      <div class="alert alert-danger">{{ $message }}</div>
                                  @enderror
                              </div>
